...
When reinstalling the local pip package for tests, make sure to delete any of the following folders/files: `build`, `dist` and `*.egg.info` generated on the root folder of the project,
